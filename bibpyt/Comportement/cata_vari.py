...
DICT_NOM_VARI = {
"AAAR": _(u"CFLUENDO avancement AAR"),
    "ADEF": _(u"CFLUENDO avancement DEF"),
    ...
    "AFM1": _(u"CFLUENDO sulfo aluminates pour la def"),
    "AFM2": _(u"CFLUENDO sulfo aluminates pour la def"),
    "AFT1": _(u"CFLUENDO sulfo aluminates pour la def"),
    "AFT2": _(u"CFLUENDO sulfo aluminates pour la def"),
    ...
    "ATIL": _(u"CFLUENDO sulfo aluminates pour la def"),
    "AUSTENITE": _(u"phase métallurgique acier variable (austenite)"),
    "BAINITE": _(u"phase métallurgique acier variable (bainite)"),
    "BIOG": _(u"CFLUENDO coeff de Biot effectif pour les RGI"),
    "BIOW": _(u"CFLUENDO coeff de Biot effectif pour la capillarite"),
    ...
    "CSHR": _(u"CFLUENDO perte de viscosité par séchage (coeff de consolidation par séchage)"),
    ...
    "DCG1": _(u"CFLUENDO endommagements principaux de compression difffus RGI"),
    "DCG2": _(u"CFLUENDO endommagements principaux de compression difffus RGI"),
    "DCG3": _(u"CFLUENDO endommagements principaux de compression difffus RGI"),
    "DC": _(u"CFLUENDO endommagement de compression"),
    ...
    "DFLU": _(u"CFLUENDO endomagement par fluage"),
    ...
    "DRL1": _(u"CFLUENDO endommagements principaux de refermeture"),
    "DRL2": _(u"CFLUENDO endommagements principaux de refermeture"),
    "DRL3": _(u"CFLUENDO endommagements principaux de refermeture"),
    "DSW1": _(u"CFLUENDO Cumul des surpessions capillaires en dessiccation sous charge"),
    "DSW2": _(u"CFLUENDO Cumul des surpessions capillaires en dessiccation sous charge"),
    "DSW3": _(u"CFLUENDO Cumul des surpessions capillaires en dessiccation sous charge"),
    "DSW4": _(u"CFLUENDO Cumul des surpessions capillaires en dessiccation sous charge"),
    "DSW5": _(u"CFLUENDO Cumul des surpessions capillaires en dessiccation sous charge"),
    "DSW6": _(u"CFLUENDO Cumul des surpessions capillaires en dessiccation sous charge"),
    "DTG1": _(u"CFLUENDO endommagements principaux de traction diffus RGI"),
    "DTG2": _(u"CFLUENDO endommagements principaux de traction diffus RGI"),
    "DTG3": _(u"CFLUENDO endommagements principaux de traction diffus RGI"),
    "DTHE": _(u"CFLUENDO endommagement thermique isotrope"),
    "DTHE": _(u"endommagement thermique"),
    "DTL1": _(u"CFLUENDO endommagements principaux de traction directe "),
    "DTL1": _(u"densite de fissuration diffuse de traction"),
    "DTL2": _(u"CFLUENDO endommagements principaux de traction directe "),
    "DTL2": _(u"densite de fissuration diffuse de traction"),
    "DTL3": _(u"CFLUENDO endommagements principaux de traction directe "),
    "DTL3": _(u"densite de fissuration diffuse de traction"),
    "DTPP": _(u"CFLUENDO endommagement de traction diffus pre pic"),
    ...
    "EMT1": _(u"CFLUENDO deformation plastique maximale atteinte en traction"),
    "EMT2": _(u"CFLUENDO deformation plastique maximale atteinte en traction"),
    "EMT3": _(u"CFLUENDO deformation plastique maximale atteinte en traction"),
    "EMT4": _(u"CFLUENDO deformation plastique maximale atteinte en traction"),
    "EMT5": _(u"CFLUENDO deformation plastique maximale atteinte en traction"),
    "EMT6": _(u"CFLUENDO deformation plastique maximale atteinte en traction"),
    ...
    "EPC1": _(u"CFLUENDO defromations plastiques de druker prager"),
    "EPC2": _(u"CFLUENDO defromations plastiques de druker prager"),
    "EPC3": _(u"CFLUENDO defromations plastiques de druker prager"),
    "EPC4": _(u"CFLUENDO defromations plastiques de druker prager"),
    "EPC5": _(u"CFLUENDO defromations plastiques de druker prager"),
    "EPC6": _(u"CFLUENDO defromations plastiques de druker prager"),
    "EPE1": _(u"CFLUENDO  deformations elastiques"),
    "EPE2": _(u"CFLUENDO  deformations elastiques"),
    "EPE3": _(u"CFLUENDO deformations elastiques"),
    "EPE4": _(u"CFLUENDO deformations elastiques"),
    "EPE5": _(u"CFLUENDO deformations elastiques"),
    "EPE6": _(u"CFLUENDO deformations elastiques"),
    "EPEQIRRA": _(u"déformation plastique équivalente d'irradiation"),
    "EPG1": _(u"CFLUENDO deformation plastique fissuration rgi"),
    "EPG2": _(u"CFLUENDO deformation plastique fissuration rgi"),
    "EPG3": _(u"CFLUENDO deformation plastique fissuration rgi"),
    "EPG4": _(u"CFLUENDO deformation plastique fissuration rgi"),
    "EPG5": _(u"CFLUENDO deformation plastique fissuration rgi"),
    "EPG6": _(u"CFLUENDO deformation plastique fissuration rgi"),
    "EPK1": _(u"CFLUENDO deformation de l etage de Kelvin"),
    "EPK2": _(u"CFLUENDO deformation de l etage de Kelvin"),
    "EPK3": _(u"CFLUENDO deformation de l etage de Kelvin"),
    "EPK4": _(u"CFLUENDO deformation de l etage de Kelvin"),
    "EPK5": _(u"CFLUENDO deformation de l etage de Kelvin"),
    "EPK6": _(u"CFLUENDO deformation de l etage de Kelvin"),
    "EPLC": _(u"CFLUENDO deformation plastique equivalente en cisaillement"),
    "EPM1": _(u"CFLUENDO deformations de l etage de Maxwell"),
    "EPM2": _(u"CFLUENDO deformations de l etage de Maxwell"),
    "EPM3": _(u"CFLUENDO deformations de l etage de Maxwell"),
    "EPM4": _(u"CFLUENDO deformations de l etage de Maxwell"),
    "EPM5": _(u"CFLUENDO deformations de l etage de Maxwell"),
    "EPM6": _(u"CFLUENDO deformations de l etage de Maxwell"),
    ...
    "EPSVOLVP" : _(u"déformations volumiques viscoplastiques"),
    "EPT1": _(u"CFLUENDO deformation plastique de traction "),
    "EPT2": _(u"CFLUENDO deformation plastique de traction "),
    "EPT3": _(u"CFLUENDO deformation plastique de traction "),
    "EPT4": _(u"CFLUENDO deformation plastique de traction "),
    "EPT5": _(u"CFLUENDO deformation plastique de traction "),
    "EPT6": _(u"CFLUENDO deformation plastique de traction "),
    ...
    "HYDF": _(u"CFLUENDO hydratation fin de pas"),
    ...
    "PHIG": _(u"CFLUENDO potentiel des phases neoformees"),
    "PHIM": _(u"CFLUENDO dissipation etage de Maxwell"),
    ...
    "PPAS": _(u"CFLUENDO indicateur premier pas (1 si premier pas passé sinon 0)"),
    "PRE1": _(u"Pression capillaire"),
    "PRE2": _(u"Pression du gaz"),
    "PRESF": _(u"pression de fluide"),
    "PRGI": _(u"CFLUENDO pression de RGI"),
    "PSHR": _(u"CFLUENDO pression capillaire de l eau"),
    ...
    "SIG1": _(u"CFLUENDO contraintes effective squelette solide (sans pression rgi)"),
    "SIG2": _(u"CFLUENDO contraintes effective squelette solide (sans pression rgi)"),
    "SIG3": _(u"CFLUENDO contraintes effective squelette solide (sans pression rgi)"),
    "SIG4": _(u"CFLUENDO contraintes effective squelette solide (sans pression rgi)"),
    "SIG5": _(u"CFLUENDO contraintes effective squelette solide (sans pression rgi)"),
    "SIG6": _(u"CFLUENDO contraintes effective squelette solide (sans pression rgi)"),
    ...
    "SKE1": _(u"CFLUENDO contraintes elastiques de l etage de Kelvin"),
    "SKE2": _(u"CFLUENDO contraintes elastiques de l etage de Kelvin"),
    "SKE3": _(u"CFLUENDO contraintes elastiques de l etage de Kelvin"),
    "SKE4": _(u"CFLUENDO contraintes elastiques de l etage de Kelvin"),
    "SKE5": _(u"CFLUENDO contraintes elastiques de l etage de Kelvin"),
    "SKE6": _(u"CFLUENDO contraintes elastiques de l etage de Kelvin"),
    ...
    "STIL": _(u"CFLUENDO sulfo aluminates pour la def"),
    ...
    "TEPG": _(u"CFLUENDO variation de volume par fissuration rgi"),
    "TEPS": _(u"CFLUENDO variation de volume meca total"),
    ...
    "VSHR": _(u"CFLUENDO vide pour l eau  capillaire (necessaire sous iteration fluage3d"),
    "WELA": _(u"CFLUENDO  energie elastique"),    
    "WID1": _(u"CFLUENDO ouvertures fissures tenseur symétrique"),
    "WID2": _(u"CFLUENDO ouvertures fissures tenseur symétrique"),
    "WID3": _(u"CFLUENDO ouvertures fissures tenseur symétrique"),
    "WID4": _(u"CFLUENDO ouvertures fissures tenseur symétrique"),
    "WID5": _(u"CFLUENDO ouvertures fissures tenseur symétrique"),
    "WID6": _(u"CFLUENDO ouvertures fissures tenseur symétrique"),
    "WL1": _(u"CFLUENDO partie plastique de l ouverture de fissure localisee"),
    "WL2": _(u"CFLUENDO partie plastique de l ouverture de fissure localisee"),
    "WL2": _(u"ouvertures suivant les axes principaux de l'endommagement de traction localisé"),
    "WL3": _(u"CFLUENDO partie plastique de l ouverture de fissure localisee"),
    "WL3": _(u"ouvertures suivant les axes principaux de l'endommagement de traction localisé"),
    "WSHR": _(u"CFLUENDO volume d eau capillaire (necessaire sous iteration fluage3d)"),    "WL1": _(u"ouvertures suivant les axes principaux de l'endommagement de traction localisé"),
