...
"""),
    ...
    11 : _("""      L'état initial a été récupéré dans la structure de données résultat de nom <%(k1)s> pour le numéro d'ordre %(i1)d et à l'instant %(r1)19.12e"""),
...
"""),
    ...
    32 : _("""      Le champ <%(k1)s> est lu dans ETAT_INIT dans la structure de données résultats de nom <%(k2)s>"""),
    ...
    36 : _("""  Le champ <%(k1)s> est lu dans ETAT_INIT alors qu'il n'est pas nécessaire pour ce calcul. Il sera ignoré."""),

    50 : _("""
  Le champ <%(k1)s> est d'un type inconnu.
"""),

    51 : _("""  Le champ <%(k1)s> est de type <%(k2)s> mais on attend un champ de type <%(k3)s>.
