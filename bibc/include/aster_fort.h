...
#define CALLO_SETTCO(a,b) CALLOO(SETTCO,settco,a,b)
...
#define CALLO_RCMFMC_WRAP(a, b, c) CALLOOP(RCMFMC_WRAP, rcmfmc_wrap, a, b, c)
...
#define CALLO_NMDOCH_WRAP(a, b, c) CALLOPO(NMDOCH_WRAP, nmdoch_wrap, a, b, c)
