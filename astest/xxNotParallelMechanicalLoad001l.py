...
champ_meca=CREA_CHAMP(TYPE_CHAM='NOEU_DEPL_R', OPERATION='AFFE', MAILLAGE=Mesh2,
...
test.assertAlmostEqual(sfon.getValue(2, 0), 0.49486734961912593)
test.assertAlmostEqual(sfon.getValue(3, 0), 0.49486734961912593)
