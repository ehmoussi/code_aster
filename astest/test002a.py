...
imposedDof1 = code_aster.DoubleDisplacement()
...
CharMeca1 = code_aster.ImposedDoubleDisplacement()
CharMeca1.setSupportModel( monModel )
CharMeca1.setValue( imposedDof1, "Bas" )
CharMeca1.build()

imposedPres1 = code_aster.DoublePressure()
imposedPres1.setValue( code_aster.Loads.Pres, 1000. )
CharMeca2 = code_aster.DistributedDoublePressure()
