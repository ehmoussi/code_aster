...
cdef class TurbulentSpectrum(DataStructure):
    ...
    """Python wrapper on the C++ TurbulentSpectrum object"""

    def __cinit__(self, bint init=True):
        """Initialization: stores the pointer to the C++ object"""
        if init:
            self._cptr = new TurbulentSpectrumPtr(new TurbulentSpectrumInstance())
    ...
    cdef set(self, TurbulentSpectrumPtr other):
        ...
        self._cptr = new TurbulentSpectrumPtr(other)
