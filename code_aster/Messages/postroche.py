...
d'occurence de type SISM_INER_TRAN.
Si c'est un oubli, ajoutez-le, sinon utilisez RESU_MECA et non RESU_MECA_TRAN."""),

    6 : _("""Seule une occurence de RESU_MECA_TRAN peut être de type SISM_INER_TRAN"""),
    
    7 : _("""Dans l'occurence numéro %(i1)d de RESU_MECA_TRAN, les résultats donnés à
