...
"""),
    ...
    24 : _("""La fréquence numéro %(i1)d sera calculée par le processeur #%(i2)d.
"""),

    25 : _("""Calcul de la fréquence numéro %(i1)d sur le processeur #%(i2)d.
"""),

    26 : _("""Le groupe %(k1)s n'appartient pas au maillage.
"""),

    27 : _("""NOMBRE_RECEPTEUR doit être pair.
"""),

    28 : _("""Au moins un des points de contrôle dépasse la cote Z0 = %(r1).4f .
"""),

    29 : _("""On est en cas superficiel alors que SURF='NON'.
"""),

    30 : _("""Le nombre de couche de sol est différent du nombre de matériaux.
"""),

    32 : _("""Au moins un des points de contrôle est sous le substratum.
"""),

    33 : _("""Au moins un des points de contrôle est sur la limite entre deux couches de sols.
               On ne sait pas gérer ce cas en automatique, il faut passer en mode manuel.
"""),

    34 : _("""Incohérence entre GROUP_MA_INTERF et les cotes verticales.
"""),

    35 : _("""Si le maillage de l'interface est quadratique,
...
"""),
    ...
    36 : _("""Au moins un des points de contrôle est au dessus de l'interface.
               On ne sait pas gérer ce cas en automatique, il faut passer en mode manuel.
"""),

    37 : _("""L'enfoncement de l'interface dépasse la position du substratum.
"""),

    38 : _("""Erreur de précision dans la construction des sous-couches.
"""),

    39 : _("""L'interface va plus bas que le substratum.
"""),

    40 : _("""On a détecté qu'une couche de sol coïncide avec la base de l'interface.
               Pour corriger cela, on décale la couche %(r1).4f de %(r2).4f .
"""),

    41 : _("""On a détecté qu'une couche de sol coïncide avec la base de l'interface.
               Cela peut poser problème avec MISS3D
               et l'option DECALAGE_AUTO peut corriger cela automatiquement.
"""),

    42 : _("""On est en mode enfoncé et tous les noeuds de l'interface sont à la même cote Z.
