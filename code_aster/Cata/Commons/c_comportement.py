...
def C_COMPORTEMENT(COMMAND=None) :  #COMMUN#
    ...
    if COMMAND =='CALC_EUROPLEXUS':
        ...
        mcfact =   FACT(statut='f',min=1,max='**',
            ...
            b_kit_thm   = BLOC( condition = "RELATION in ['KIT_HHM','KIT_HH', 'KIT_H',\
                                                         'KIT_HM','KIT_THHM', 'KIT_THH',\
                                                         'KIT_THM','KIT_THV']",
...
# HYDR
                                ...
                                b_mfr_thm   = BLOC( condition = "'MFRONT' in RELATION_KIT",
            ...
            b_kit_meta  = BLOC( condition = "RELATION in ('META_LEMA_ANI','META_P_CL_PT_RE',\
                                                          'META_P_CL_PT','META_P_CL_RE',\
                                                          'META_P_CL','META_P_IL_PT_RE',\
                                                          'META_P_IL_PT','META_P_IL_RE',\
                                                          'META_P_IL','META_P_INL_PT_RE',\
                                                          'META_P_INL_PT','META_P_INL_RE',\
                                                          'META_P_INL', 'META_V_CL_PT_RE',\
                                                          'META_V_CL_PT','META_V_CL_RE',\
                                                          'META_V_CL','META_V_IL_PT_RE',\
                                                          'META_V_IL_PT','META_V_IL_RE',\
                                                          'META_V_IL','META_V_INL_PT_RE',\
                                                          'META_V_INL_PT','META_V_INL_RE',\
                                                          'META_V_INL')",
        ...
        if COMMAND == 'STAT_NON_LINE':
            opts['b_anneal'] = BLOC(condition =
                    "RELATION in ('VMIS_ISOT_LINE','VMIS_CINE_LINE','VMIS_ECMI_LINE','VMIS_ISOT_TRAC','VMIS_CIN1_CHAB',\
                                   'VMIS_CIN2_CHAB')",
