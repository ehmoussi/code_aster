...
# ----------------------
         b_data58   = BLOC(condition="""equal_to("FORMAT", 'IDEAS_DS58')""",
            UNITE           = SIMP(statut='f',typ=UnitType(),defaut= 19 , inout='in'),
         ),
         b_data58b  = BLOC(condition="""equal_to("FORMAT", 'IDEAS_DS58') and is_in("TYPE_RESU", ('DYNA_TRANS', 'DYNA_HARMO'))""",
...
# ---------
         b_med           =BLOC(condition = """equal_to("FORMAT", 'MED')""",fr=tr("Nom du champ dans le fichier MED"),
           ...
           FORMAT_MED      =FACT(statut='o',max='**',
             ...
             NOM_CHAM        =SIMP(statut='o',typ='TXM',max=1,validators=NoRepeat(),into=C_NOM_CHAM_INTO(),),
             NOM_CHAM_MED    =SIMP(statut='f',typ='TXM',max=1,               fr=tr("Nom du champ dans le fichier MED."),  ),
             NOM_RESU        =SIMP(statut='f',typ='TXM',max=1,               fr=tr("Prefixe du nom de champ dans le fichier MED."),  ),
