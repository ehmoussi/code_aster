...
POST_RCCM=OPER(nom="POST_RCCM",op= 165,sd_prod=table_sdaster,
         ...
         TYPE_RESU_MECA  =SIMP(statut='o',typ='TXM',into=("EVOLUTION","B3200_UNIT","ZE200a","ZE200b","B3200_T","B3600") ),
...
# ======================================================================
     b_unitaire  =BLOC(condition="(TYPE_RESU_MECA == 'B3200_UNIT')",
         ...
         TYPE_KE         =SIMP(statut='f',typ='TXM',defaut="KE_MECA",into=("KE_MECA","KE_MIXTE"),
                               fr=tr("Ke meca seul ou partition mecanique + thermique") ),
         FACT_SIGM   =FACT(statut='f',max='**',fr=tr("facteurs d'intensité de contraintes (soudure)"),
           KT_SN =SIMP(statut='f',typ='R',defaut= 1.0,fr=tr("Kt appliqué à Sn") ),
           KT_SP =SIMP(statut='f',typ='R',defaut= 1.0,fr=tr("Kt appliqué à Sp") ),
                           ),
         ...
         ENVIRONNEMENT         =FACT(statut='f',max='**',fr=tr("Donnees pour le calcul du fen"),
              TABL_YOUNG        =SIMP(statut='f',typ=table_sdaster,
                              fr=tr("table relevé du module d'young en fonction de la température") ),
              FEN_INTEGRE      =SIMP(statut='f',typ='R',defaut= 1.0),
              S_ETOILE         =SIMP(statut='f',typ='R',defaut= 1.0),
              SEUIL_EPSI_INF   =SIMP(statut='f',typ='R',fr=tr("seuil en %/s")),
              SEUIL_EPSI_SUP   =SIMP(statut='f',typ='R',fr=tr("seuil en %/s")),
              CRIT_EPSI        =SIMP(statut='f',typ='R',fr=tr("seuil en %")),
              A_ENV            =SIMP(statut='f',typ='R'),
              B_ENV            =SIMP(statut='f',typ='R'),
              C_ENV            =SIMP(statut='f',typ='R'),
              SEUIL_T_INF      =SIMP(statut='f',typ='R',fr=tr("seuil en degré")),
              SEUIL_T_SUP      =SIMP(statut='f',typ='R',fr=tr("seuil en degré")),
              VALE_T_INF        =SIMP(statut='f',typ='R',fr=tr("valeur inférieure de la température en degré")),
              VALE_T_SUP        =SIMP(statut='f',typ='R',fr=tr("valeur supérieure de la température en degré")),
              VALE_T_MOY_NUM    =SIMP(statut='f',typ='R',fr=tr("valeur moyenne au numérateur de la température en degré")),
              VALE_T_MOY_DEN    =SIMP(statut='f',typ='R',fr=tr("valeur moyenne au dénominateur de la température en degré")),
                               ),

                      ),
# ======================================================================
     b_ze200a  =BLOC(condition="(TYPE_RESU_MECA == 'ZE200a')",
         ...
         INDI_SIGM =FACT(statut='o',max='**',fr=tr("indices de contraintes"),
            C1              =SIMP(statut='o',typ='R',defaut=1.0,fr=tr("indice de contraintes C1 du RCCM")),
            K1              =SIMP(statut='o',typ='R',defaut=1.0,fr=tr("indice de contraintes K1 du RCCM")),
            C2              =SIMP(statut='o',typ='R',defaut=1.0,fr=tr("indice de contraintes C2 du RCCM")),
            K2              =SIMP(statut='o',typ='R',defaut=1.0,fr=tr("indice de contraintes K2 du RCCM")),
            C3              =SIMP(statut='o',typ='R',defaut=1.0,fr=tr("indice de contraintes C3 du RCCM")),
            K3              =SIMP(statut='o',typ='R',defaut=1.0,fr=tr("indice de contraintes K3 du RCCM")),
                         ),
         TUYAU =FACT(statut='o',max='**',fr=tr("caracteristiques geometriques de la tuyauterie"),
            R              =SIMP(statut='o',typ='R',fr=tr("rayon de la tuyauterie")),
            EP              =SIMP(statut='o',typ='R',fr=tr("epaisseur de la tuyauterie")),
            I              =SIMP(statut='o',typ='R',fr=tr("inertie de la tuyauterie")),
                         ),
...
# ======================================================================
     b_ze200b  =BLOC(condition="(TYPE_RESU_MECA == 'ZE200b')",
         ...
         SITUATION         =FACT(statut='o',max='**',fr=tr("Situation"),
              ...
              NUME_GROUPE      =SIMP(statut='o',typ='I',
                                        fr=tr("numéros des groupes de la situation") ),
              NUME_RESU_THER   =SIMP(statut='f',typ='I',max=1,fr=tr("numeros de transitoires thermiques") ),
              NUME_RESU_PRES   =SIMP(statut='f',typ='I',max=1,fr=tr("numeros de transitoires de pression") ),
              CHAR_ETAT_A      =SIMP(statut='o',typ='I',max='**',fr=tr("numeros de chargements etat A") ),
              CHAR_ETAT_B      =SIMP(statut='o',typ='I',max='**',fr=tr("numeros de chargements etat B") ),
              TEMP_REF_A       =SIMP(statut='f',typ='R',fr=tr("temperature référence etat A")),
              TEMP_REF_B       =SIMP(statut='f',typ='R',fr=tr("temperature référence etat B")),
...
# ======================================================================
     b_b3200t  =BLOC(condition="(TYPE_RESU_MECA == 'B3200_T')",
         ...
         SITUATION         =FACT(statut='o',max='**',fr=tr("Situation"),
              ...
              NUME_RESU_THER   =SIMP(statut='f',typ='I',max=1,fr=tr("numeros de transitoires thermiques") ),
              NUME_RESU_PRES   =SIMP(statut='f',typ='I',max=1,fr=tr("numeros de transitoires de pression") ),
              NUME_RESU_MECA   =SIMP(statut='o',typ='I',max=1,fr=tr("numeros de transitoires dus aux efforts") ),
              TEMP_REF_A       =SIMP(statut='f',typ='R',fr=tr("temperature référence etat A")),
              TEMP_REF_B       =SIMP(statut='f',typ='R',fr=tr("temperature référence etat B")),
              O_ETOILE         =SIMP(statut='f',typ='R'),
              TABL_TEMP        =SIMP(statut='f',typ=table_sdaster,
...
# ======================================================================
     b_tuyauterie  =BLOC(condition="(TYPE_RESU_MECA == 'B3600')",
