...
# --- Method for contact
                                          ...
                                          b_cont_pena_noadapt=BLOC(condition = """(equal_to("ALGO_CONT", 'PENALISATION') and equal_to("ADAPTATION", 'NON')) or (equal_to("ALGO_CONT", 'PENALISATION') and equal_to("ADAPTATION", 'CYCLAGE'))  """, fr=tr("Paramètres de la méthode pénalisée"),
...
# --- Method for friction
                                          ...
                                          b_frot_pena_noadapt=BLOC(condition = """(equal_to("ALGO_FROT", 'PENALISATION') and equal_to("ADAPTATION", 'NON')) or (equal_to("ALGO_FROT", 'PENALISATION') and equal_to("ADAPTATION", 'CYCLAGE'))  """, fr=tr("Paramètres de la méthode pénalisée"),
