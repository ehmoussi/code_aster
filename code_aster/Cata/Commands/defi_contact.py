...
# --- Method for contact
                                          ...
                                          #ADAPTATION      =SIMP(statut='f',typ='TXM',defaut="ADAPT_COEF",
                                          ...
                                          b_adapt_pena=BLOC(condition = """(equal_to("ALGO_CONT", 'PENALISATION') and not equal_to("ADAPTATION", 'TOUT'))  or (equal_to("ALGO_CONT", 'PENALISATION') and not equal_to("ADAPTATION", 'ADAPT_COEF')) """, fr=tr("COEF_PENA_CONT obligatoire pour la méthode pénalisée sans adaptation"),
                                                           COEF_PENA_CONT  =SIMP(statut='o',typ='R'),
                                          ),
...
# --- Method for friction
                                          ...
                                          b_frot_pena     =BLOC(condition = """equal_to("ALGO_FROT", 'PENALISATION')""",
                                                                  ...
                                                                  COEF_PENA_FROT  =SIMP(statut='f',typ='R',defaut=1.E2,),
                                                                  ADAPTATION      =SIMP(statut='f',typ='TXM',defaut="ADAPT_COEF", into=("ADAPT_COEF","CYCLAGE","TOUT","NON"),),
                                          ),
                                          b_frot_adapt_pena     =BLOC(condition = """(equal_to("ALGO_FROT", 'PENALISATION') and not equal_to("ADAPTATION", 'ADAPT_COEF')) or (equal_to("ALGO_FROT", 'PENALISATION') and not equal_to("ADAPTATION", 'TOUT'))""",
                                                                  fr=tr("Paramètres de la méthode pénalisée"),
