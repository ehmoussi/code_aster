...
#
                                          ...
                                          b_appa_fixe     =BLOC(condition = "TYPE_PROJECTION == 'FIXE'",
...
# --- Pairing options (for standard slave/master)
                                          b_pair_std=BLOC(condition = "ALGO_CONT == 'STANDARD' or ALGO_CONT == 'PENALISATION' ",
...
# --- Pairing options (for segment to segment contact)
                                          b_pair_mortar=BLOC(condition = "ALGO_CONT == 'LAC' ",
                                                          fr=tr("Options d'appariement standard "),
                                                          APPARIEMENT     =SIMP(statut='f',typ='TXM',defaut="MORTAR",
                                                                                into=("MORTAR",)),
                                                          TYPE_APPA       =SIMP(statut='f',typ='TXM',defaut="ROBUSTE",
                                                                                into=("ROBUSTE","RAPIDE",)),
                                                          RESI_APPA       =SIMP(statut='f',typ='R'  ,defaut=1.E-8),
                                                          TYPE_JACOBIEN   =SIMP(statut='f',typ='TXM',defaut="INITIAL",
                                                                                into=("INITIAL","ACTUALISE",),),
                                                          INTEGRATION     =SIMP(statut='f',typ='TXM',defaut="AUTO",
                                                                                into=("AUTO",),),
...
# -- Fonctionnalités spécifiques 'XFEM'
                                       ...
                                       ALGO_LAGR      = SIMP(statut='f',typ='TXM',defaut="AUTO",
