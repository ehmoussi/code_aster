...
DEFI_SOL_EQUI = MACRO(nom="DEFI_SOL_EQUI",
   ...
   b_ONDE =BLOC ( condition = """equal_to("CHARGEMENT", 'ONDE_PLANE')""",
      regles=(UN_PARMI('FONC_SIGNAL','UNITE_TRAN_INIT','FONC_SIGNAL_X'),
   ...
   NMAX_ITER       =SIMP(statut='f',typ='I',defaut=10,val_min=1,
   ...
   FREQ_FILTRE     =SIMP(statut='f',typ='R',defaut=0.0,
                         fr=tr("frequence filtrage du signal") ),
   INTEGRATION   =SIMP(statut='f',typ='TXM',into=("TEMPS","FREQUENCE",),defaut="TEMPS",
