...
DEFI_MATERIAU=OPER(nom="DEFI_MATERIAU",op=5,sd_prod=mater_sdaster,
       ...
       regles=(EXCLUS('ELAS','ELAS_FO','ELAS_FLUI','ELAS_ISTR','ELAS_ISTR_FO','ELAS_ORTH',
               ...
               AU_MOINS_UN('ELAS','ELAS_FO','ELAS_FLUI','ELAS_ISTR','ELAS_ISTR_FO','ELAS_ORTH',
                           ...
                           'VERI_BORNE','TRACTION','ECRO_LINE','ENDO_HETEROGENE','ECRO_LINE_FO','ECRO_PUIS','ECRO_PUIS_FO',
                           'ECRO_COOK','ECRO_COOK_FO','BETON_ECRO_LINE','BETON_REGLE_PR','ENDO_ORTH_BETON','PRAGER','PRAGER_FO',
                           'TAHERI','TAHERI_FO','ROUSSELIER','ROUSSELIER_FO','VISC_SINH','VISC_SINH_FO','CIN1_CHAB','CIN1_CHAB_FO',
                           'CIN2_CHAB','CIN2_CHAB_FO','CIN2_NRAD','MEMO_ECRO','MEMO_ECRO_FO','VISCOCHAB','VISCOCHAB_FO','LEMAITRE','LEMAITRE_IRRA',
                           'VISC_IRRA_LOG','GRAN_IRRA_LOG','LEMA_SEUIL','LEMA_SEUIL_FO','IRRAD3M','LEMAITRE_FO',
                           'ARME','ASSE_CORN','DIS_CONTACT','ENDO_SCALAIRE','ENDO_SCALAIRE_FO','ENDO_LOCA_EXP','ENDO_LOCA_EXP_FO','ENDO_FISS_EXP','ENDO_FISS_EXP_FO','DIS_GRICRA',
                           'BETON_DOUBLE_DP','MAZARS','MAZARS_FO','JOINT_BA','VENDOCHAB','VENDOCHAB_FO','HAYHURST','HAYHURST_FO','VISC_ENDO','VISC_ENDO_FO','PINTO_MENEGOTTO',
                           ...
                           'GLRC_DM','DHRC','CORR_ACIER','CABLE_GAINE_FROT','DIS_ECRO_CINE','DIS_VISC','DIS_ECRO_TRAC','DIS_BILI_ELAS','DIS_CHOC_ENDO',
                           'THER_NL','THER_HYDR','THER','THER_FO','THER_ORTH','THER_NL_ORTH','THER_COQUE','THER_COQUE_FO',
                           'SECH_GRANGER','SECH_MENSI','SECH_BAZANT','SECH_NAPPE','META_ACIER','META_ZIRC', 'DURT_META','ELAS_META','ELAS_META_FO',
                           'META_ECRO_LINE','META_TRACTION','META_VISC_FO','META_PT','META_RE','FLUIDE',
                           'COMP_THM',
...
# Discrets non-linéaires : début
         ...
         DIS_CHOC_ENDO =FACT(statut='f',
            ...
            CRIT_AMOR =SIMP(statut='o',typ='TXM',into=("INCLUS","EXCLUS")),
            #
            AMORIN    =SIMP(statut='c',typ='R',),
...
#
           ...
           GTN             =FACT(statut='f',
             ...
             NUCL_PORO = SIMP(statut='f',typ='R',defaut= 0.0),
             NUCL_PLAS = SIMP(statut='f',typ='R',defaut= 0.1),
             NUCL_DEV  = SIMP(statut='f',typ='R',defaut= 0.05),
           ),
