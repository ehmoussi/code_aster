...
#
           ...
           GTN_ASTER       =FACT(statut='f',
             Q1       =SIMP(statut='o',typ='R'),
             Q2       =SIMP(statut='o',typ='R'),
             PORO_INI = SIMP(statut='o',typ='R'),
             PORO_COA = SIMP(statut='f',typ='R',defaut= 0.0),
             COAL_ACC = SIMP(statut='f',typ='R',defaut= 1.0),
             NUCL_POR = SIMP(statut='f',typ='R',defaut= 0.0),
             NUCL_PLA = SIMP(statut='f',typ='R',defaut= 0.1),
             NUCL_DEV = SIMP(statut='f',typ='R',defaut= 0.05),
           ),
           VISC_REG       =FACT(statut='f',
             SIGM_0          =SIMP(statut='o',typ='R'),
             EPSI_0          =SIMP(statut='o',typ='R'),
             M               =SIMP(statut='o',typ='R'),
