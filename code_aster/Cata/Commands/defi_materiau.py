...
DEFI_MATERIAU=OPER(nom="DEFI_MATERIAU",op=5,sd_prod=mater_sdaster,
       ...
       regles=(EXCLUS('ELAS','ELAS_FO','ELAS_FLUI','ELAS_ISTR','ELAS_ISTR_FO','ELAS_ORTH',
               ...
               AU_MOINS_UN('ELAS','ELAS_FO','ELAS_FLUI','ELAS_ISTR','ELAS_ISTR_FO','ELAS_ORTH',
                           ...
                           'VISC_IRRA_LOG','GRAN_IRRA_LOG','LEMA_SEUIL','LEMA_SEUIL_FO','IRRAD3M','LEMAITRE_FO','META_LEMA_ANI','META_LEMA_ANI_FO',
                           ...
                           'FLUA_PORO_BETON','ENDO_PORO_BETON','FLUENDO','RGI_FLUENDO',
                           'GLRC_DM','DHRC','CORR_ACIER','CABLE_GAINE_FROT','DIS_ECRO_CINE','DIS_VISC','DIS_ECRO_TRAC','DIS_BILI_ELAS',
...
#
           ...
           BETON_UMLV   =FACT(statut='f',
            ...
            BETON_RAG   =FACT(statut='f',
                COMP_BETON = SIMP(statut='o',typ='TXM',into=("ENDO","ENDO_FLUA","ENDO_FLUA_RAG"),
                                  defaut="ENDO"),
           ...
           FLUA_PORO_BETON      =FACT(statut='f',
             ...
             PORO            =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.15),
             VW              =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule,'R'),defaut=0.15),
