...
# ==============================================================================
    DISCRET = FACT(statut='f',max='**',
        ...
        b_SYME_OUI = BLOC(condition="""equal_to("SYME", 'OUI')""",
            ...
            CARA = SIMP(statut='f',typ='TXM',max=1,defaut="None",
...
# ==============================================================================
    POUTRE_FLUI = FACT(statut='f',max='**',
        ...
        B_TN         = SIMP(statut='f',typ='R',defaut= 0.E+0 ),
...
# ==============================================================================
    GRILLE = FACT(statut='f',max='**',
        ...
        ANGL_REP_1      = SIMP(statut='f',typ='R',min=2,max=2, fr=tr("Angles de rotation permettant de définir l'axe local x.") ),
        ANGL_REP_2      = SIMP(statut='f',typ='R',min=2,max=2, fr=tr("Angles de rotation permettant de définir l'axe local y.")),
        EXCENTREMENT    = SIMP(statut='f',typ='R'),
        EXCENTREMENT_FO = SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule) ),
        VECT_1          = SIMP(statut='f',typ='R',min=3,max=3, fr=tr("La projection de ce vecteur sert à définir l'axe local x.")),
        VECT_2          = SIMP(statut='f',typ='R',min=3,max=3,fr=tr("La projection de ce vecteur sert à définir l'axe local y.")),
...
# ==============================================================================
   MEMBRANE = FACT(statut='f',max='**',
      ...
      MAILLE     = SIMP(statut='c',typ=ma  ,validators=NoRepeat(),max='**'),
      GROUP_MA   = SIMP(statut='f',typ=grma,validators=NoRepeat(),max='**'),
      EPAIS      = SIMP(statut='o',typ='R',val_min=0.0, fr=tr("Epaisseur de la membrane ; donnée utilisée uniquement dans le cas non linéaire.")),
      ANGL_REP_1 = SIMP(statut='f',typ='R',min=2,max=2,fr=tr("Angles de rotation permettant de définir l'axe local x.")),
      ANGL_REP_2 = SIMP(statut='f',typ='R',min=2,max=2,fr=tr("Angles de rotation permettant de définir l'axe local y.")),
      VECT_1     = SIMP(statut='f',typ='R',min=3,max=3, fr=tr("La projection de ce vecteur sert à définir l'axe local x.")),
      VECT_2     = SIMP(statut='f',typ='R',min=3,max=3, fr=tr("La projection de ce vecteur sert à définir l'axe local y.")),
