...
cdef extern from "Materials/MaterialBehaviour.h":
    ...
    cdef cppclass ElasticMaterialBehaviourInstance( GeneralMaterialBehaviourInstance ):

        ElasticMaterialBehaviourInstance()

    cdef cppclass ElasticMaterialBehaviourPtr:

        ElasticMaterialBehaviourPtr( ElasticMaterialBehaviourPtr& )
        ElasticMaterialBehaviourPtr( ElasticMaterialBehaviourInstance* )
        ElasticMaterialBehaviourInstance* get()
