...
cdef class GeneralizedModel(DataStructure):
    ...
    """Python wrapper on the C++ GeneralizedModel object"""

    def __cinit__(self, bint init=True):
        """Initialization: stores the pointer to the C++ object"""
        if init:
            self._cptr = new GeneralizedModelPtr(new GeneralizedModelInstance())
    ...
    cdef set(self, GeneralizedModelPtr other):
        ...
        self._cptr = new GeneralizedModelPtr(other)
