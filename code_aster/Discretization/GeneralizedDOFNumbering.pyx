...
cdef class GeneralizedDOFNumbering(DataStructure):
    ...
    """Python wrapper on the C++ GeneralizedDOFNumbering object"""

    def __cinit__(self, bint init=True):
        """Initialization: stores the pointer to the C++ object"""
        if init:
            self._cptr = new GeneralizedDOFNumberingPtr(new GeneralizedDOFNumberingInstance())
    ...
    cdef set(self, GeneralizedDOFNumberingPtr other):
        ...
        self._cptr = new GeneralizedDOFNumberingPtr(other)
