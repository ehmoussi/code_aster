...
cdef extern from "Studies/StudyDescription.h":

    cdef cppclass StudyDescriptionInstance:

        StudyDescriptionInstance( ModelPtr& model, MaterialOnMeshPtr& mater)
        void addKinematicsLoad( KinematicsLoadPtr& currentLoad )
        void addMechanicalLoad( GenericMechanicalLoadPtr& currentLoad )

    cdef cppclass StudyDescriptionPtr:

        StudyDescriptionPtr( StudyDescriptionPtr& )
        StudyDescriptionPtr( StudyDescriptionInstance * )
        StudyDescriptionInstance* get()
