...
cdef class StructureInterface(DataStructure):
    ...
    cdef set(self, StructureInterfacePtr other):
        ...
        self._cptr = new StructureInterfacePtr(other)
    ...
    def addInterface(self, name, typ, groupsOfNodes, components):
        cdef VectorComponent val2
        for cVal in components:
            val2.push_back(cVal)
        self.getInstance().addInterface(name, typ, groupsOfNodes, val2)
