...
cdef class GenericGeneralizedAssemblyMatrix(DataStructure):
    ...
    """Python wrapper on the C++ GeneralizedAssemblyMatrix object"""
    ...
    cdef set(self, GenericGeneralizedAssemblyMatrixPtr other):
        ...
        self._cptr = new GenericGeneralizedAssemblyMatrixPtr(other)
...
cdef class GeneralizedAssemblyMatrixDouble(GenericGeneralizedAssemblyMatrix):
    ...
    def __cinit__(self, bint init=True):
        """Initialization: stores the pointer to the C++ object"""
        if init:
            self._cptr = <GenericGeneralizedAssemblyMatrixPtr *>\
                new GeneralizedAssemblyMatrixDoublePtr(new GeneralizedAssemblyMatrixDoubleInstance())
...
cdef class GeneralizedAssemblyMatrixComplex(GenericGeneralizedAssemblyMatrix):
    ...
    def __cinit__(self, bint init=True):
        ...
        if init:
            self._cptr = <GenericGeneralizedAssemblyMatrixPtr *>\
                new GeneralizedAssemblyMatrixComplexPtr(new GeneralizedAssemblyMatrixComplexInstance())
