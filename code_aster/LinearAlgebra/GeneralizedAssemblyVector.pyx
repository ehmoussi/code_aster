...
cdef class GenericGeneralizedAssemblyVector(DataStructure):
    ...
    """Python wrapper on the C++ GeneralizedAssemblyVector object"""
    ...
    cdef set(self, GenericGeneralizedAssemblyVectorPtr other):
        ...
        self._cptr = new GenericGeneralizedAssemblyVectorPtr(other)
...
cdef class GeneralizedAssemblyVectorDouble(GenericGeneralizedAssemblyVector):
    ...
    def __cinit__(self, bint init=True):
        """Initialization: stores the pointer to the C++ object"""
        if init:
            self._cptr = <GenericGeneralizedAssemblyVectorPtr *>\
                new GeneralizedAssemblyVectorDoublePtr(new GeneralizedAssemblyVectorDoubleInstance())
...
cdef class GeneralizedAssemblyVectorComplex(GenericGeneralizedAssemblyVector):
    ...
    def __cinit__(self, bint init=True):
        ...
        if init:
            self._cptr = <GenericGeneralizedAssemblyVectorPtr *>\
                new GeneralizedAssemblyVectorComplexPtr(new GeneralizedAssemblyVectorComplexInstance())
