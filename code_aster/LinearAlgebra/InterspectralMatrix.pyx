...
cdef class InterspectralMatrix(DataStructure):
    ...
    """Python wrapper on the C++ InterspectralMatrix object"""

    def __cinit__(self, bint init=True):
        """Initialization: stores the pointer to the C++ object"""
        if init:
            self._cptr = new InterspectralMatrixPtr(new InterspectralMatrixInstance())
    ...
    cdef set(self, InterspectralMatrixPtr other):
        ...
        self._cptr = new InterspectralMatrixPtr(other)
