...
cdef class StaticMacroElement(DataStructure):
    ...
    """Python wrapper on the C++ StaticMacroElement object"""

    def __cinit__(self, bint init=True):
        """Initialization: stores the pointer to the C++ object"""
        if init:
            self._cptr = new StaticMacroElementPtr(new StaticMacroElementInstance())
    ...
    cdef set(self, StaticMacroElementPtr other):
        ...
        self._cptr = new StaticMacroElementPtr(other)
