...
waf configure --use-config=gaia_gcc_std --prefix=../install/std
waf install -p
"""
...
#YAMMROOT='/projets/simumeca/public_gcc'
...
def configure(self):
    ...
    official_programs.check_prerequisites_package(self, YAMMROOT, '20190402')
