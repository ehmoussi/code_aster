...
class MaterialOnMeshInstance : public DataStructure {
  ...
  public:
    ...
    void addBehaviourOnGroupOfElements( BehaviourDefinitionPtr &curBehav,
        ...
        _behaviours.push_back( listOfBehavAndGrpsValue(
    ...
    void addBehaviourOnElement( BehaviourDefinitionPtr &curBehav,
        ...
        _behaviours.push_back(
            listOfBehavAndGrpsValue( curBehav, MeshEntityPtr( new Element( nameOfElement ) ) ) );
    };
    ...
    void addMaterialOnAllMesh( MaterialPtr &curMater ) {
        _materialsOnMeshEntity.push_back(
    ...
    void addMaterialOnGroupOfElements( MaterialPtr &curMater,
        ...
        _materialsOnMeshEntity.push_back( listOfMatsAndGrpsValue(
            curMater, MeshEntityPtr( new GroupOfElements( nameOfGroup ) ) ) );
    };
    ...
    void addMaterialOnElement( MaterialPtr &curMater,
        ...
        _materialsOnMeshEntity.push_back(
            listOfMatsAndGrpsValue( curMater, MeshEntityPtr( new Element( nameOfElement ) ) ) );
    };
