/**
 * @file FourierCombinationInterface.cxx
...
void exportFourierCombinationToPython() {
    ...
    py::class_< FourierCombinationInstance, FourierCombinationPtr, py::bases< ResultsContainerInstance > >(
        "FourierCombination", py::no_init )
