#ifndef MECHANICALMODECONTAINERINTERFACE_H_
#define MECHANICALMODECONTAINERINTERFACE_H_

/**
 * @file MechanicalModeContainerInterface.h
 * @brief Fichier entete de la classe MechanicalModeContainerInterface
