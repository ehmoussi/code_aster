...
std::string JeveuxBidirectionalMapInstance::findStringOfElement( long elementNumber )
{
...
long JeveuxBidirectionalMapInstance::findIntegerOfElement( std::string elementName )
{
    char* charJeveuxObjName = MakeBlankFStr(32);
