...
class CharMecaInstance: public DataStructure
{
    public:
...
template class CharMecaInstance< ForceDoubleInstance, NodalForce >;
typedef CharMecaInstance< ForceDoubleInstance, NodalForce > NodalForceDoubleInstance;
