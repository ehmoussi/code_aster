...
MechanicalLoadInstance::MechanicalLoadInstance():DataStructure( initAster->getNewResultObjectName(), "CHAR_MECA" ),
                                _jeveuxName( getName() ),
...
// la commande AFFE_CHAR_MECA 
    CommandSyntax syntaxeAffeCharMeca("AFFE_CHAR_MECA", true, initAster->getResultObjectName());
...
// MODELE=    
    ...
    mCSModel.addValues(_supportModel->getJeveuxName());
    cout <<  "Nom du modele support: " << _supportModel->getJeveuxName() << " . " << endl;
