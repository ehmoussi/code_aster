...
const std::set< PhysicalQuantityComponent > PhysicalQuantityTraits<Force>::components(
    ForceComponents, ForceComponents + nbForceComponents );
...
const std::set< PhysicalQuantityComponent > PhysicalQuantityTraits<Pressure>::components(
    PressureComponents, PressureComponents + nbPressureComponents );

/* Temperature */
const PhysicalQuantityComponent TemperatureComponents[nbTemperatureComponents] = {
    Temp, MiddleTemp };
...
const std::set< PhysicalQuantityComponent > PhysicalQuantityTraits<Impedance>::components(
    ImpedanceComponents, ImpedanceComponents + nbImpedanceComponents );
...
const std::set< PhysicalQuantityComponent > PhysicalQuantityTraits<HeatFlux>::components(
    HeatFluxComponents, HeatFluxComponents + nbHeatFluxComponents );

/* HydraulicFlux */
const PhysicalQuantityComponent HydraulicFluxComponents[nbHydraulicFluxComponents] = {
    FlunHydr1, FlunHydr2 };
