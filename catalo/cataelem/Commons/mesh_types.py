...
#------------------------------------------------------------
TETRA9 = MeshType(nbno=9, dim=3, code='TE9')

TE9 = Elrefe()
TE9.addLocation('NOEU', 4)
TE9.addLocation('NOEU_S', 4)
TE9.addLocation('FPG1', 1)
TE9.addLocation('FPG4', 4)
TE9.addLocation('FPG4NOS', 8)
TE9.addLocation('FPG5', 5)
TE9.addLocation('FPG11', 11)
TE9.addLocation('FPG15', 15)
TETRA9.addElrefe(TE9)
