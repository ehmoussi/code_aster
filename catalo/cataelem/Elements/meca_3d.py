...
class MECA_HEXA20(Element):
    ...
    calculs = (
        ...
        OP.CALC_G_GLOB(te=27,
            para_in=((SP.PACCELE, DDL_MECA), (OP.CALC_G_GLOB.PCOMPOR, LC.CCOMPOR),
        ...
        OP.CALC_G_GLOB_F(te=27,
            para_in=((SP.PACCELE, DDL_MECA), (OP.CALC_G_GLOB_F.PCOMPOR, LC.CCOMPOR),
        ...
        OP.REST_ECRO(te=116,
            para_in=((SP.PCARCRI, CCARCRI), (OP.REST_ECRO.PCOMPOR, LC.CCOMPOR),
                     (SP.PMATERC, LC.CMATERC), (SP.PTEMPSR, CTEMPSR),
