...
CHHOGTH  = LocatedComponents(phys=PHY.N6480R, type='ELEM',
    components=('X[336]',))

CHHOGTT  = LocatedComponents(phys=PHY.N6480R, type='ELEM',
    components=('X[264]',))

CHHOSTH  = LocatedComponents(phys=PHY.N6480R, type='ELEM',
    components=('X[784]',))
...
class MECA3DH27_HHO121(Element):
    ...
    elrefe =(
            ElrefeLoc(MT.H27, gauss = ('RIGI=FPG8','FPG1=FPG1',), mater=('RIGI', 'FPG1',),),
...
#------------------------------------------------------------
class MECA3DTE8_HHO121(MECA3DH27_HHO121):
    """Please document this element"""
    meshType = MT.TETRA8
    nodes = (
    ...
    elrefe =(
           ElrefeLoc(MT.TE8, gauss = ('RIGI=FPG4','FPG1=FPG1',), mater=('RIGI', 'FPG1',),),
