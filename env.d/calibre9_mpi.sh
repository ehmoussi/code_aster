...
export LIBPATH_MEDCOUPLING="${PREREQ_PATH}/tools/Medcoupling_mpi-V9_6_0a2/lib"
export INCLUDES_MEDCOUPLING="${PREREQ_PATH}/tools/Medcoupling_mpi-V9_6_0a2/include"
export PYPATH_MEDCOUPLING="${PREREQ_PATH}/tools/Medcoupling_mpi-V9_6_0a2/lib/python3.6/site-packages"
...
export PYTHONPATH=${PYPATH_NUMPY}:${PYPATH_ASRUN}:${PYPATH_MFRONT}:${PYPATH_MEDCOUPLING}:${PYTHONPATH}
