...
!   Material parameters (elasticity)
    ...
    ds_thm%ds_material%elas%alpha        = r8nnem()
    ds_thm%ds_material%elas%alpha_l      = r8nnem()
    ds_thm%ds_material%elas%alpha_t      = r8nnem()
    ds_thm%ds_material%elas%alpha_n      = r8nnem()
