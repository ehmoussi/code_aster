...
! ======================================================================
    real(kind=8) :: l
    dp11p1 = 1/((rho12*r*temp/rho11/kh)-1)
    dp11p2 = (r*temp/kh - 1)/((rho12*r*temp/rho11/kh)-1)
    dp12p1 = 1/(r*temp/kh-(rho11/rho12))
    dp12p2 = (r*temp/kh-1)*dp12p1
    dp21p1 = - dp12p1
    dp21p2 = 1 - dp12p2
    if ((yate.eq.1)) then
        l = (congem(adcp12+ndim+1)-congem(adcp11+ndim+1))
        dp11t = (-l*r*rho12/kh+padp/temp)/((rho12*r*temp/rho11/kh)-1)
        dp12t = (-l*rho11+padp)/temp*dp12p1
        dp21t = - dp12t
    endif
! ======================================================================
end subroutine
