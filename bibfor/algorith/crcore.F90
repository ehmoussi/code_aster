...
!
    ...
    integer :: nbordr1, nbordr2, ier1, numei, neq
!
    real(kind=8) :: rbid, tps, prec, valrr(3), coef(3), coefr
    complex(kind=8) :: cbid
!
    character(len=1) :: typmat
    character(len=4) :: typabs
    character(len=8) :: k8b, resu, typmod, criter, resui, matr
    ...
    character(len=24) :: k24, linst, nsymb, nsymb0, typres, lcpt, o1, o2
